...
-- Copiando dados para a tabela diztribui.cargo: ~2 rows (aproximadamente)
DELETE FROM `cargo`;
/*!40000 ALTER TABLE `cargo` DISABLE KEYS */;
INSERT INTO `cargo` (`pkCargo`, `nome`, `created_at`, `updated_at`, `fkEmpresa`) VALUES
	(1, 'Analista de Ti', '2020-05-26 06:49:47', '2020-05-26 06:49:47', 1),
	(2, 'Teste', '2020-05-26 08:30:27', '2020-05-26 08:30:27', NULL),
	(3, 'Teste', '2020-05-26 08:30:44', '2020-05-26 08:30:44', NULL),
	(4, 'asdasdasd', '2020-05-26 08:31:28', '2020-05-26 08:31:28', 1);
...
INSERT INTO `categorias` (`pkCategoria`, `created_at`, `updated_at`, `fkEmpresa`, `titulo`) VALUES
	(1, '2020-05-26 09:14:28', '2020-05-26 09:14:28', 1, 'Novs Categoria'),
	(2, '2020-05-26 09:45:41', '2020-05-26 09:45:41', 1, 'Categoria de Teste'),
	(4, '2020-05-26 09:46:05', '2020-05-26 09:46:05', 1, 'asdasdasd'),
	(5, '2020-05-26 09:46:15', '2020-05-26 09:46:15', 1, 'asdasdasd');
...
CREATE TABLE IF NOT EXISTS `empresa` (
  ...
  `nomeFantasia` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
INSERT INTO `empresa` (`pkEmpresa`, `razaoSocial`, `nomeFantasia`, `cnpj`, `endereco`, `site`, `telefone`, `redeSocial`, `ramoDeAtividade`, `responsavelMarketing`, `responsavelFinanceiro`, `responsavelComercial`, `numero`, `complemento`, `bairro`, `cidade`, `estado`, `cep`, `created_at`, `updated_at`) VALUES
	(1, 'Rebeca e Sarah Consultoria Financeira ME', 'Rebeca e Sarah Consultoria Financeira ME', '09.058.480/0001-16', 'Rua das Perpétuas', NULL, '(31) 97538-0034', NULL, NULL, NULL, NULL, NULL, 125, NULL, NULL, 'Belo Horizonte', 'MG', '30690-270', '2020-05-26 06:48:05', '2020-05-26 06:48:05');
...
-- Copiando dados para a tabela diztribui.gestor: ~2 rows (aproximadamente)
DELETE FROM `gestor`;
/*!40000 ALTER TABLE `gestor` DISABLE KEYS */;
INSERT INTO `gestor` (`pkGestor`, `fkSetor`, `created_at`, `updated_at`, `fkEmpresa`, `fkUsuario`, `ehmaster`) VALUES
	(1, 2, '2020-05-26 06:57:38', '2020-05-26 06:57:38', 1, 1, 1),
	(2, NULL, '2020-05-26 07:09:19', '2020-05-26 07:09:19', 1, 3, 1);
...
-- Copiando dados para a tabela diztribui.items: ~0 rows (aproximadamente)
DELETE FROM `items`;
...
-- Copiando dados para a tabela diztribui.materias: ~1 rows (aproximadamente)
DELETE FROM `materias`;
/*!40000 ALTER TABLE `materias` DISABLE KEYS */;
INSERT INTO `materias` (`pkMateria`, `created_at`, `updated_at`, `fkTema`, `titulo`, `descricao`, `fkCategoria`) VALUES
	(1, '2020-05-26 09:54:47', '2020-05-26 09:54:47', NULL, 'aaddasdsad', 'sadasdadasd', 1);
...
-- Copiando dados para a tabela diztribui.questionarios: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela diztribui.questoes: ~0 rows (aproximadamente)
...
-- Copiando dados para a tabela diztribui.setor: ~1 rows (aproximadamente)
DELETE FROM `setor`;
/*!40000 ALTER TABLE `setor` DISABLE KEYS */;
INSERT INTO `setor` (`pkSetor`, `nome`, `created_at`, `updated_at`, `fkEmpresa`) VALUES
	(2, 'Setor Test', '2020-05-26 06:49:27', '2020-05-26 06:49:27', 1),
	(4, 'asdasasdasd', '2020-05-26 08:35:50', '2020-05-26 08:35:50', 1);
...
-- Copiando dados para a tabela diztribui.usuario: ~3 rows (aproximadamente)
DELETE FROM `usuario`;
...
INSERT INTO `usuario` (`pkUsuario`, `nome`, `email`, `cpf`, `telefone`, `urlImage`, `created_at`, `updated_at`, `fkEmpresa`, `fkSetor`, `fkCargo`, `facebook`, `instagram`, `twitter`, `linkedin`, `site`, `password`, `administrador`) VALUES
	(1, 'Lucas Borges', 'ryok21@gmail.com', '06460094608', '31975380034', NULL, '2020-05-13 12:47:25', '2020-05-13 12:47:25', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '$2y$10$vJfykP7PRwKsbv5aYF7VzOFo/IptsfK3Az9NmHFzt7trovmQNLtQC', 1),
	(2, 'Tezt Zapify', 'suporte@zapify.com.br', '064.600.946-08', '(31) 97538-0034', NULL, '2020-05-26 06:57:18', '2020-05-26 06:57:18', 1, NULL, NULL, 'f', 'i', 't', 'l', 's', NULL, NULL),
	(3, 'Gestor master Zapify', 'master@zapify.com.br', '488.289.420-37', '(31) 99999-999', NULL, '2020-05-26 06:58:51', '2020-05-26 06:58:51', 1, NULL, NULL, 'f', 'i', 't', 'l', 's', NULL, NULL),
	(5, 'Lucas 2', 'contato@lborges.com.br', '048.046.540-11', '(31) 99999-9999', NULL, '2020-05-26 07:51:27', '2020-05-26 07:51:27', 1, 2, 1, 'f', 'i', 't', 'l', 's', '$2y$10$rTLbKm2NjZn4JhByEut5c.0Okey7tA0DJt9JKv0BmcQ7AUokDqwJ2', NULL);
